    ...
    def run(self, max_epochs=float('inf')):
        ...
        for epoch in itertools.count():
            ...
            for sample in self._train_set_loader:
                ...
                print(f"Times: pred:{pred_time - start_time} loss:{loss_time - pred_time} backward:{backward_time - loss_time} stats_step:{stats_step_time - backward_time} total:{backward_time - start_time}")
